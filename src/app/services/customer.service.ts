...
export class CustomerService {
  ...
  getCustomerList(companyId:number):Observable<Customer[]>{
    const url = `${this.api.CUSTOMER_URL}/${companyId}`;
  ...
  saveCustomer(customer: Customer): Observable<Customer> {
    return this.httpClient.post<Customer>(this.api.CUSTOMER_URL, customer);
  }
